...
if choice1 == 'left':
    ...
    if choice2 == 'wait':
        choice3 = input("You arrived at the island unharmed. There is a house with 3 doors. One 'red', one 'yellow' and one 'blue'. Which one would you choose? ").lower()
        if  choice3 == 'red':
            print("You chose a room full of fire. Game Over.")
        elif choice3 == 'yellow':
            print("Congratulations! You found the treasure. You Won.")
        elif choice3 == 'blue':
            print("You chose a room full of beasts. Game Over.")
        else:
